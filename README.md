# 📝 README – Auto-Generated Blog (React + Node.js + PostgreSQL + Docker + AWS)
...
### ✅ Full CRUD API (Minimal for the challenge)

GET /articles → list all articles

GET /articles/:id → Get a single article

POST /articles/generateArticle → Create a custom article by sending it the data (title, content, summary)

POST /articles/generateAIArticle → Create a IA generated article by sending it the data, the title can be send as "title" in the body of the request
